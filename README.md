...
* Engineer features for stronger statistical testing and predictive modeling
* Evaluate dataset and detect trends
...
For a detailed discussion of results, refer to the reports folder. For a summarized version of key results, refer to the next section.
